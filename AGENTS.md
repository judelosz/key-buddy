...
Scope in progress: **Phase 3.5 — MVP hardening and user testing.** Phases 0–3 are implemented; the next post-MVP pass will replace the shell with landing onboarding plus Missions, Free Play, AFK Mode, Progress, and Settings. The Tier 1–5 curriculum vertical slice, SongMastery, and validated XP/Level meter are next; Streaks, Riffs, full curriculum expansion, and mic input remain future work.
