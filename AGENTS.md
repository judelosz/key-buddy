...
Scope in progress: **Phase 3.5 — MVP hardening and user testing.** Phases 0–3 are implemented; the curriculum vertical slice is next. SessionBuilder, adaptive difficulty, AFK, roadmap/goals/cosmetics/onboarding, full curriculum expansion, and mic input remain future work.
